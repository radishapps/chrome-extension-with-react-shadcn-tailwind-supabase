            ...
            <nav className="flex flex-col items-center gap-4 px-2 py-5">
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <a
                                className={`hover:cursor-pointer flex h-9 w-9 items-center justify-center  text-muted-foreground transition-colors ${sidebarType == SidebarType["webpage-parser"] ? "rounded-full bg-primary text-lg font-semibold text-primary-foreground" : ""}`}
                                href="#" onClick={() => {
                                setSidebarType(SidebarType["webpage-parser"])
                                sideNav(SidebarType["webpage-parser"])
                            }}
                            >
                                <BiSearchAlt
                                    className={`h-4 w-4 transition-all group-hover:scale-110`}/>
                                <span className="sr-only">webpage parser</span>
                            </a>
                        </TooltipTrigger>
                        <TooltipContent side="right">Webpage Parser</TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            </nav>
